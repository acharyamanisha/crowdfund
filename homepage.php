        ...
        <div class="row">
            <blockquote>
                <h5>
                    <p>Your Feed</p>
                    <h5>
                        <small>Here's are some <cite title="Source Title">Projects from the users you
                                follow!</cite></small>
            </blockquote>
            ...
            <div class="col-sm-4">
                <div class="card">
                    ...
                    <img src='img/blank.png' alt='Project Pic' title='Project Pic' style="width:128px;height:128px">
                    <?php
                            } else { ?>
                    ...
                    <div class="card-block">
                        ...
                        <a href="viewProject.php?project_id=<?php echo $row['PROJECT_ID']; ?>"
